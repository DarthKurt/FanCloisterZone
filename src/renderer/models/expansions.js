...
export class Expansion {
  ...
  static register (expansion) { expansion.fan = true; Expansion[expansion.name] = expansion; delete Expansion.__all }
  static unregisterAll () { Expansion.all().filter(exp => exp.fan).forEach(exp => delete Expansion[exp.name]); delete Expansion.__all }
  static all () {
    if (Expansion.__all === undefined) Expansion.__all = Object.values(Expansion).filter(prop => prop instanceof Expansion)
    return Expansion.__all
  }
}

Expansion._UNKNOWN = { name: '_UNKNOWN', title: 'Missing expansion' }
...
export const INNS_AND_CATHEDRALS = Expansion.INNS_AND_CATHEDRALS = new Expansion('INNS_AND_CATHEDRALS', 'Inns & Cathedrals', { implies: ['big-follower', 'cathedral', 'inn'], ai: true })
export const TRADERS_AND_BUILDERS = Expansion.TRADERS_AND_BUILDERS = new Expansion('TRADERS_AND_BUILDERS', 'Traders & Builders', { implies: ['builder', 'pig', 'traders'], impliesAllowed: ['pig-herd'], ai: true })
export const PRINCESS_AND_DRAGON = Expansion.PRINCESS_AND_DRAGON = new Expansion('PRINCESS_AND_DRAGON', 'The Princess & The Dragon', { implies: ['dragon', 'fairy', 'princess', 'portal'] })
export const TOWER = Expansion.TOWER = new Expansion('TOWER', 'The Tower', { implies: ['tower'] })
export const ABBEY_AND_MAYOR = Expansion.ABBEY_AND_MAYOR = new Expansion('ABBEY_AND_MAYOR', 'Abbey & Mayor', { implies: ['abbey', 'barn', 'mayor', 'wagon'] })
export const BRIDGES_CASTLES_AND_BAZAARS = Expansion.BRIDGES_CASTLES_AND_BAZAARS = new Expansion('BRIDGES_CASTLES_AND_BAZAARS', 'Bridges, Castles and Bazaars', { implies: ['bridge', 'castle', 'bazaar'] })
export const HILLS_AND_SHEEP = Expansion.HILLS_AND_SHEEP = new Expansion('HILLS_AND_SHEEP', 'Hills & Sheep', { implies: ['shepherd', 'hill', 'vineyard'] })
export const UNDER_THE_BIG_TOP = Expansion.UNDER_THE_BIG_TOP = new Expansion('UNDER_THE_BIG_TOP', 'Under The Big Top', { implies: ['big-top', 'ringmaster', 'acrobats'] })
export const KING_AND_ROBBER = Expansion.KING_AND_ROBBER = new Expansion('KING_AND_ROBBER', 'King and Robber', { implies: ['king', 'robber'] })
export const RIVER = Expansion.RIVER = new Expansion('RIVER', 'The River', { enforces: ['river'], ai: true }, [
...
export const GQ11 = Expansion.GQ11 = new Expansion('GQ11', 'The Mini Expansion (GQ11)', { ai: true }, [
...
export const WIND_ROSES = Expansion.WIND_ROSES = new Expansion('WIND_ROSES', 'The Wind Roses', { enforces: ['wind-rose'], ai: true })
...
export const FERRIES = Expansion.FERRIES = new Expansion('FERRIES', 'The Ferries', { implies: ['ferry'] })
export const GOLDMINES = Expansion.GOLDMINES = new Expansion('GOLDMINES', 'The Goldmines', { implies: ['gold'] })
export const MAGE_AND_WITCH = Expansion.MAGE_AND_WITCH = new Expansion('MAGE_AND_WITCH', 'Mage & Witch', { implies: ['mage', 'witch'] })
export const WATCHTOWERS = Expansion.WATCHTOWERS = new Expansion('WATCHTOWERS', 'The Watchtowers', { enforces: ['watchtower'], ai: true })
...
export const DARMSTADT = Expansion.DARMSTADT = new Expansion('DARMSTADT', 'Darmstadt', { enforces: ['church'], ai: true })
export const SPIEL_DOCH = Expansion.SPIEL_DOCH = new Expansion('SPIEL_DOCH', 'Spiel Doch', { ai: true })
